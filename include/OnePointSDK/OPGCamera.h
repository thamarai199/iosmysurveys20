...
@interface OPGPictureOptions : NSObject
...
@property (strong) OPGPictureOptions* pictureOptions;
...
+ (instancetype) createFromPictureOptions:(OPGPictureOptions*)options;

@end

// ======================================================================= //

@interface OPGCamera : OPGPlugin <UIImagePickerControllerDelegate,
 ...
 */
- (void)takePicture:(OPGInvokedUrlCommand*)command;
