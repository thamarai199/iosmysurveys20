        ...
        if (callbacktype == "initmonitor") {
           ...
           // alert('in not updated one');
            ...
            cordovaFunction.loadGeoFencingLocations([], function(locations){
                                                    ...
                                                    //alert(JSON.stringify(locations.PopUpSurveys.SurveyID));
           ...
           /* navigator.notification.confirm(languageScript.translate('GeofencingInitiatorText'),
                                           ...
                                           [languageScript.translate('Ok'),languageScript.translate('takeSurvey')]);*/
            //result.callbacktype
            //result.regionId
            //result.message
            //result.timestamp
...
geofencingPopToggle: function(){
    ...
    cordovaFunction.getData('enableSurvey',function(data){
                            ...
                            //alert(data.value.indexOf(app.popUpShowId[0]));
