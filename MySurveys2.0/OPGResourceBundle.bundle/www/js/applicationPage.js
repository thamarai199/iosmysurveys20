			...
			applicationPage.checkIndex(file_url).done(function() {
				...
				$('.body_container').load(file_url,function(){
                                          /*var len = $('script').filter(function () {
                                                                       ...
                                                                       console.log(js_url);
                                                                       console.log($(this).attr('src') == js_url);
                                                                       
                                                                       }).length;*/
                                        //                                  if(js_url == 'js/subPageScripts/survey.js'){
//                                          if(applicationPage.scriptAdd){
//                                          
                                          //$.getScript(js_url).done(function(){
//                                                                   alert("done " + applicationPage.scriptAdd);
//                                                                   applicationPage.scriptAdd = false;
//                                                                   alert("done after removing " + applicationPage.scriptAdd);
//                                                                   }).fail(function() {
...
//                                                                        applicationPage.scriptAdd = false;
//                                                                        alert("fail " +  applicationPage.scriptAdd);
//                                                                    });
//                                          }
//                                          }
//                                          else{
                                       //   if($.inArray(js_url, applicationPage.loadedArray) < 0){
//                                          if(js_url != 'js/subPageScripts/survey.js'){
//                                          alert("survey is not calling");
                                                $.getScript(js_url,function(){
                                                             //    applicationPage.loadedArray.push(js_url);
                                                      }).fail(function() {
                                                                           var fileref=document.createElement('script');
                                                                           fileref.setAttribute("type","text/javascript");
                                                                           fileref.setAttribute("src", js_url);
...
//                                          }
                                       //   }
                                                                                    //}
                                          /*var len = $('script[src*="'+js_url+'"]').length;
