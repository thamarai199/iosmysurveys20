...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" exclude-result-prefixes="fo">
    ...
    <xsl:template match="Question">
        ...
        <xsl:if test="Style/@ElementAlign = 'NewLine'">
            <xsl:choose>
                <xsl:when test="not($bWithinTable)">
                    <div>
                        <br />
                    </div>
                </xsl:when>
    ...
    <xsl:template name="LabelNoLabel">
        <xsl:element name="Label">
            <xsl:attribute name="style">position:relative;right:-0.9em</xsl:attribute>
    ...
    <xsl:template match="Table">
        ...
        <xsl:choose>
            <xsl:when test="@UseTablesLayout = '7'">
                <xsl:element name="div">
                    <xsl:if test="$bIncludeCSSStyles">
                    ...
                    <xsl:call-template name="DivRow">
                        <xsl:with-param name="Orientation" select="$Orientation" />
                    </xsl:call-template>
                </xsl:element>
            </xsl:when>
            <xsl:when test="@UseTablesLayout = '8'">
                <xsl:element name="div">
                    <xsl:if test="$bIncludeCSSStyles">
                        <xsl:attribute name="class">mrQuestionTable</xsl:attribute>
                    </xsl:if>
                    ...
                    <xsl:call-template name="DivRow2">
                        <xsl:with-param name="Orientation" select="$Orientation" />
                    </xsl:call-template>
                </xsl:element>
            </xsl:when>
            <xsl:when test="@UseTablesLayout = '9'">
                <xsl:element name="div">
                    <xsl:if test="$bIncludeCSSStyles">
                        <xsl:attribute name="class">mrQuestionTable</xsl:attribute>
                    </xsl:if>
                    ...
                    <xsl:call-template name="DivHorizontalRow">
                        <xsl:with-param name="Orientation" select="$Orientation" />
                    </xsl:call-template>
                </xsl:element>
            </xsl:when>
            <xsl:when test="@UseTablesLayout = '10'">
                <xsl:element name="div">
                    <xsl:if test="$bIncludeCSSStyles">
                        <xsl:attribute name="class">mrQuestionTable</xsl:attribute>
                    </xsl:if>
                    ...
                    <xsl:call-template name="DivNoLabelsRow">
                        <xsl:with-param name="Orientation" select="$Orientation" />
                    </xsl:call-template>
                </xsl:element>
            </xsl:when>
            <xsl:when test="@UseTablesLayout = '6'">
                <xsl:element name="ul">
                    <xsl:attribute name="data-role">rank</xsl:attribute>
                    <xsl:if test="$bIncludeCSSStyles">
                        <xsl:attribute name="class">mrQuestionTable</xsl:attribute>
                    </xsl:if>
                    <xsl:call-template name="UlRow">
                        <xsl:with-param name="Orientation" select="$Orientation" />
                    </xsl:call-template>
                </xsl:element>
            </xsl:when>
            <xsl:when test="@UseTablesLayout = '5'">
                <xsl:element name="span">
                    <xsl:if test="$bIncludeCSSStyles">
                        <xsl:attribute name="class">mrQuestionTable</xsl:attribute>
                    </xsl:if>
            ...
            <xsl:when test="@UseTablesLayout = '4'">
        ...
        <xsl:choose>
            <xsl:when test="Control[1]/Style/Cell/@ColSpan">
                <xsl:attribute name="colspan">
                    <xsl:value-of select="Control[1]/Style/Cell/@ColSpan"/>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="Label[1]/Style/Cell/@ColSpan">
                <xsl:attribute name="colspan">
                    <xsl:value-of select="Label[1]/Style/Cell/@ColSpan"/>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="Error[1]/Style/Cell/@ColSpan">
                <xsl:attribute name="colspan">
                    <xsl:value-of select="Error[1]/Style/Cell/@ColSpan"/>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="Question[1]/Style/Cell/@ColSpan">
                <xsl:attribute name="colspan">
                    <xsl:value-of select="Question[1]/Style/Cell/@ColSpan"/>
                </xsl:attribute>
            </xsl:when>
        ...
        <xsl:choose>
            <xsl:when test="Control[1]/Style/Cell/@RowSpan">
                <xsl:attribute name="rowspan">
                    <xsl:value-of select="Control[1]/Style/Cell/@RowSpan"/>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="Label[1]/Style/Cell/@RowSpan">
                <xsl:attribute name="rowspan">
                    <xsl:value-of select="Label[1]/Style/Cell/@RowSpan"/>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="Error[1]/Style/Cell/@RowSpan">
                <xsl:attribute name="rowspan">
                    <xsl:value-of select="Error[1]/Style/Cell/@RowSpan"/>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="Question[1]/Style/Cell/@RowSpan">
                <xsl:attribute name="rowspan">
                    <xsl:value-of select="Question[1]/Style/Cell/@RowSpan"/>
                </xsl:attribute>
            </xsl:when>
    ...
    <xsl:template name="UlRow">
        <xsl:param name="Orientation" select="Column" />
        <xsl:for-each select="Row">
            <xsl:sort select="@Y" order="ascending" data-type="number"/>
            <xsl:element name="li">
                <xsl:call-template name="UlCell">
                    <xsl:with-param name="Orientation" select="$Orientation" />
                </xsl:call-template>
            </xsl:element>
        </xsl:for-each>
            ...
            <xsl:choose>
                <xsl:when test="Control[1]/Style">
                    <xsl:for-each select="Control[1]">
                        <xsl:attribute name="style">
                            <xsl:call-template name="CellStyle">
                                <xsl:with-param name="bUseTablesLayout" select="true()" />
                                <xsl:with-param name="Orientation" select="$Orientation" />
                            </xsl:call-template>
                        </xsl:attribute>
                    </xsl:for-each>
    ...
    <xsl:template name="DivHorizontalRow">
        <xsl:param name="Orientation" select="Column" />
        <xsl:for-each select="Row">
            <xsl:sort select="@Y" order="ascending" data-type="number"/>
            <xsl:element name="fieldset">
                <xsl:attribute name="data-role">controlgroup</xsl:attribute>
                ...
                <xsl:call-template name="DivCell">
                    <xsl:with-param name="Orientation" select="$Orientation" />
                </xsl:call-template>
            </xsl:element>
        </xsl:for-each>
    ...
    <xsl:template name="DivNoLabelsRow">
        <xsl:param name="Orientation" select="Column" />
        <xsl:for-each select="Row">
            <xsl:sort select="@Y" order="ascending" data-type="number"/>
            <xsl:element name="div">
                ...
                <xsl:call-template name="DivNoLabelsCell">
                    <xsl:with-param name="Orientation" select="$Orientation" />
                </xsl:call-template>
            </xsl:element>
        </xsl:for-each>
    ...
    <xsl:template name="DivNoLabelsCell">
        <xsl:param name="Orientation" select="Column" />
        <xsl:for-each select="Cell">
            <xsl:sort select="@X" order="ascending" data-type="number" />
            <xsl:element name="div">
                ...
                <xsl:for-each select="*">
                    <xsl:choose>
                        <xsl:when test="name() = 'Control'">
                            <xsl:apply-templates select=".">
                                <xsl:with-param name="bNoLabel" select="true()"/>
                            </xsl:apply-templates>
                        </xsl:when>
                        <xsl:when test="name() = 'Label'">
                            <xsl:call-template name="LabelNoLabel">
                                <xsl:with-param name="sLabelClass" select="'mrQuestionText'"/>
                                <xsl:with-param name="bWithinTable" select="true()"/>
                            </xsl:call-template>
                        </xsl:when>
    ...
    <xsl:template match="Control">
        ...
        <xsl:choose>
            ...
            <xsl:when test="@Type = 'Media'">
                <xsl:call-template name="MediaControl"/>
            </xsl:when>
            <xsl:when test="@Type = 'Slider'">
                <xsl:call-template name="SliderControl"/>
            </xsl:when>
            <xsl:when test="@Type = 'Star'">
                <xsl:call-template name="StarControl"/>
            </xsl:when>
            ...
            <xsl:when test="@Type = 'Email'">
                <xsl:call-template name="DateControl">
                    <xsl:with-param name="controlType" select="@Type" />
                </xsl:call-template>
            </xsl:when>
    ...
    <xsl:template name="BarCodeControl">
        ...
        <xsl:element name="input">
            <!--- Set Control Type -->
            <xsl:attribute name="data-role">barcode</xsl:attribute>
            <!--- Input name -->
    ...
    <xsl:template name="MediaControl">
        <!--- Control Label -->
        <xsl:if test="Category[1]/Label">
            <xsl:choose>
                <xsl:when test="$bIncludeElementIds">
        ...
        <xsl:element name="input">
            ...
            <xsl:attribute name="data-role">
                <xsl:value-of select="Style/@MediaType"/>
            </xsl:attribute>
            <!--- Control Attr -->
            <xsl:attribute name="control-attr">
                <xsl:call-template name="ControlAttr"/>
            </xsl:attribute>
            <!--- Input name -->
            <xsl:attribute name="name">
                <xsl:value-of select="@QuestionName"/>
    ...
    <xsl:template name="HotspotControl">
        <!--- Control Label -->
        <xsl:if test="Category[1]/Label">
            <xsl:choose>
                <xsl:when test="$bIncludeElementIds">
        ...
        <xsl:element name="input">
            <!--- Set Control Type -->
            <xsl:attribute name="data-role">hotspot</xsl:attribute>
            <!--- Input name -->
            <xsl:attribute name="name">
                <xsl:value-of select="@QuestionName"/>
                <xsl:if test="Category[1]/@Name">
    ...
    <xsl:template name="GeoCodeControl">
        <!--- Control Label -->
        <xsl:if test="Category[1]/Label">
            <xsl:choose>
                <xsl:when test="$bIncludeElementIds">
        ...
        <xsl:element name="input">
            <!--- Set Control Type -->
            <xsl:attribute name="data-role">geocode</xsl:attribute>
            <!--- Input name -->
            <xsl:attribute name="name">
                <xsl:value-of select="@QuestionName"/>
                <xsl:if test="Category[1]/@Name">
    ...
    <xsl:template name="SliderControl">
        <!--- Control Label -->
        <xsl:if test="Category[1]/Label">
            <xsl:choose>
                <xsl:when test="$bIncludeElementIds">
        ...
        <xsl:element name="input">
            ...
            <xsl:attribute name="data-highlight">true</xsl:attribute>
            <!--- Input name -->
            <xsl:attribute name="name">
                <xsl:value-of select="@QuestionName"/>
                <xsl:if test="Category[1]/@Name">
            ...
            <!-- Vertical alignment -->
            <xsl:if test="Style/@Orientation = 'Column'">
                <xsl:attribute name="data-vertical">true</xsl:attribute>
            </xsl:if>
            
            <!--- Min Max -->
            <xsl:if test="Validation/@MinValue">
                <xsl:attribute name="min">
                    <xsl:value-of select="Validation/@MinValue"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="Style/@SliderType">
                <xsl:attribute name="slider-type">
                    <xsl:value-of select="Style/@SliderType"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="Style/@StarType">
                <xsl:attribute name="star-type">
                    <xsl:value-of select="Style/@StarType"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="Style/@Low">
                <xsl:attribute name="low">
                    <xsl:value-of select="Style/@Low"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="Style/@High">
                <xsl:attribute name="high">
                    <xsl:value-of select="Style/@High"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="Validation/@MaxValue">
                <xsl:attribute name="max">
                    <xsl:value-of select="Validation/@MaxValue"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="Validation/@StepValue">
                <xsl:attribute name="step">
                    <xsl:value-of select="Validation/@StepValue"/>
                </xsl:attribute>
            </xsl:if>
            <!--- Default text -->
            <xsl:attribute name="value">
    ...
    <xsl:template name="StarControl">
        ...
        <xsl:element name="input">
            <!--- Set Control Type -->
            <xsl:attribute name="data-role">star</xsl:attribute>
            <!--- Input name -->
            <xsl:attribute name="name">
                <xsl:value-of select="@QuestionName"/>
                <xsl:if test="Category[1]/@Name">
    ...
    <xsl:template name="SingleLineEditControl">
        ...
        <xsl:element name="input">
            ...
            <!--- Mask -->
            <xsl:if test="Style/@Mask != ''">
                <xsl:attribute name="data-mask">
                    <xsl:value-of select="Style/@Mask"/>
                </xsl:attribute>
            </xsl:if>
            <!--- Placeholder -->
            <xsl:if test="Style/@Placeholder != ''">
                <xsl:attribute name="data-placeholder">
                    <xsl:value-of select="Style/@Placeholder"/>
                </xsl:attribute>
            </xsl:if>
            <!--- AutoComplete -->
            <xsl:choose>
            ...
            <xsl:if test="Style/@Hidden = 'true'">
                <xsl:attribute name="data-role">none</xsl:attribute>
            </xsl:if>
            <!--- Set Control Style -->
            <xsl:attribute name="style">
                <xsl:call-template name="ControlStyle"/>
    ...
    <xsl:template name="DateControl">
        ...
        <xsl:element name="input">
            ...
            <xsl:if test="Style/@Mask != ''">
                <xsl:attribute name="data-mask">
                    <xsl:value-of select="Style/Control/@Mask"/>
                </xsl:attribute>
            </xsl:if>
            <!--- AutoComplete -->
            <xsl:choose>
    ...
    <!--- Control Attributes -->
    <xsl:template name="ControlAttr">
        <!--- adds the label styles to a style attribute -->
        <xsl:if test="Style/@AccessGallery">AccessGallery;</xsl:if><xsl:if test="Style/@AccessNew">AccessNew;</xsl:if><xsl:if test="Style/@AllowPlayback">AllowPlayback;</xsl:if><xsl:if test="Style/@AllowUpload">AllowUpload;</xsl:if>
    </xsl:template>
    ...
    <xsl:template name="LabelStyle">
        <!--- adds the label styles to a style attribute -->
        <xsl:if test="Style/@BgColor">background-color: <xsl:value-of select="Style/@BgColor"/>;</xsl:if><xsl:if test="Style/@Color">color: <xsl:value-of select="Style/@Color"/>;</xsl:if><xsl:if test="Style/@Indent">margin-left: <xsl:value-of select="Style/@Indent"/>em;</xsl:if><xsl:if test="Style/@Width">width: <xsl:value-of select="Style/@Width"/>;</xsl:if><xsl:if test="Style/@Height">height: <xsl:value-of select="Style/@Height"/>;</xsl:if><xsl:if test="Style/@Hidden = 'true'">visibility: hidden;</xsl:if><xsl:if test="Style/@Hidden = 'true'">display: none;</xsl:if><xsl:if test="Style/@ZIndex">z-index: <xsl:value-of select="Style/@ZIndex"/>;</xsl:if>
        <xsl:choose>
            <xsl:when test="Style/@Cursor = 'EResize'">cursor: e-resize;</xsl:when><xsl:when test="Style/@Cursor = 'NEResize'">cursor: ne-resize;</xsl:when><xsl:when test="Style/@Cursor = 'NResize'">cursor: n-resize;</xsl:when><xsl:when test="Style/@Cursor = 'NWResize'">cursor: nw-resize;</xsl:when><xsl:when test="Style/@Cursor = 'WResize'">cursor: w-resize;</xsl:when><xsl:when test="Style/@Cursor = 'SWResize'">cursor: sw-resize;</xsl:when><xsl:when test="Style/@Cursor = 'SResize'">cursor: s-resize;</xsl:when><xsl:when test="Style/@Cursor = 'SEResize'">cursor: se-resize;</xsl:when><xsl:when test="Style/@Cursor">cursor: <xsl:value-of select="Style/@Cursor"/>;</xsl:when>
        </xsl:choose>
    ...
    <xsl:template name="BlockStyle">
        ...
        <xsl:if test="Style/Cell/@BgColor">background: <xsl:value-of select="Style/Cell/@BgColor"/>;</xsl:if>
