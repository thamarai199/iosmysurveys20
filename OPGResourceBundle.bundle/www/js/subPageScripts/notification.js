var Notification = {
                           ...
                           $.each(data,function(i, val){
                                  ...
                                  if($("ul#thelist li input[data-value="+val['AppNotificationID']+"]").length == 0){
												 ...
												 Notification.scroll = new iScroll('wrapper');
                                                    ...
                                                    $(".ntfScroller").append("<div class='ntfNotFound largefont'>"+languageScript.translate('NoNotifications')+"</div>");
    ...
    bindListners : function() {
        ...
        $(".editNtf").on("click",function(){
                         $(this).hide();
                         $(".checkNtfDelete").css({"background-image":'url("././images/check_normal.png")',"width":"28px","height":"28px"});
        ...
        $(".deleteNotify").on("click",function(ev){
                           ...
                           var DleteNtfList = $('input[type="checkbox"][checked="checked"]').map(function(){
                            ...
                            if(DleteNtfList.length == 0){
                                 ...
                                 utils.displayAlert(languageScript.translate('selectNotification'));
                              }else{
                                $("span.rightArrow").hide();
                                cordovaFunction.DeletePushNotification(DleteNtfList,
                                   function(data){
                                                                  ...
                                                                  $.each(DleteNtfList,function(i,index){
                                                                       ...
                                                                       $("div.ntfsubHeader").css("width","100%");
                                                                       }
        ...
        $(".cancelNotify").on("click",function(e){
                              ...
                              $(".checkNtfDelete").hide();$('input[type="checkbox"]').removeAttr("checked");$(".ntfsubHeader").removeClass("adjustWidth");
