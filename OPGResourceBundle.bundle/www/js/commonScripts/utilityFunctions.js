var utils = {
    ...
    styleBody : function() {
        ...
        var headerHeight = 0,footerHeight = 0,wrapperHeight = 0 , refershNotifyHeight = 0 ;
        ...
        if($('#refershNotify').length > 0 && $('#refershNotify').is(':visible'))
            refershNotifyHeight = $('#refershNotify').outerHeight();
        
        wrapperHeight = bodyHeight - headerHeight - footerHeight - refershNotifyHeight;
    ...
    displayAlert : function(message){
        if (isMobile.Android() && isMobile.getAndroidVersion() < 3.0)
            ...
            try{
                navigator.notification.alert(message, null, "My Surveys",languageScript.translate('ok'));
            }catch(e){alert(e);}
        }
    },
